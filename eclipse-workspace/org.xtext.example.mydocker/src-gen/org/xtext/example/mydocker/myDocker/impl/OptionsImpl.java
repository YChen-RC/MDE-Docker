 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydocker.myDocker.impl.OptionsImpl#getOptions <em>Options</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OptionsImpl extends MinimalEObjectImpl.Container implements Options
{
  ...
  {
    return MyDockerPackage.Literals.OPTIONS;
  }
  ...
  public EList<Option> getOptions()
  {
    if (options == null)
    {
      options = new EObjectContainmentEList<Option>(Option.class, this, MyDockerPackage.OPTIONS__OPTIONS);
    }
    return options;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MyDockerPackage.OPTIONS__OPTIONS:
